...
$sql_select_posts = "SELECT B.bejegyzes_id, TO_CHAR(B.bejegyzes_idopont, 'YYYY.MM.DD. HH24:MI') as bejegyzes_idopont, B.bejegyzes_leiras, F.kep_url, F.kep_leiras, U.felh_nev 
                     FROM Bejegyzes B 
                     LEFT JOIN Fenykep F ON B.fenykep_id = F.kep_id 
                     JOIN Felhasznalo U ON B.felh_id = U.felh_id
                     ORDER BY B.bejegyzes_idopont DESC";
